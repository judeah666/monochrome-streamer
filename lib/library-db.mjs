...
export async function readLibraryAlbumPage(databasePath, options = {}) {
  ...
  try {
    ...
    addTokenSearchFilter(where, params, ['title', 'artist', 'album_artist', 'collection_name', 'year'], search, 'albumSearch');
...
export async function readCollectionAlbumPage(databasePath, options = {}) {
  ...
  try {
    ...
    addTokenSearchFilter(where, params, ['title', 'artist', 'album_artist', 'collection_name', 'year'], search, 'collectionSearch');
    addLetterFilter(where, params, 'title', letter);
...
export async function readCollectionFolders(databasePath, options = {}) {
  ...
  try {
    ...
    addTokenSearchFilter(where, params, ['collection_name'], search, 'collectionNameSearch');
...
export async function readCollectionFolderAlbumPage(databasePath, folderPath, options = {}) {
  ...
  try {
    ...
    addTokenSearchFilter(where, params, ['title', 'artist', 'album_artist', 'collection_name', 'year'], search, 'collectionFolderSearch');
    addLetterFilter(where, params, 'title', letter);
...
export async function readTrackPage(databasePath, options = {}) {
  ...
  try {
    ...
    addTokenSearchFilter(where, params, ['title'], search, 'trackSearch');
    addLetterFilter(where, params, 'title', letter);
...
export async function readArtistPage(databasePath, options = {}) {
  ...
  try {
    ...
    const params = {};
    const artistWhere = [];
    addTokenSearchFilter(artistWhere, params, ['artist'], search, 'artistSearch');
...
export async function readFolderListing(databasePath, folderPath = '', options = {}) {
  ...
  try {
    ...
    addTokenSearchFilter(trackWhere, trackParams, ['title', 'artist', 'album', 'normalized_relative_path'], search, 'folderTrackSearch');
...
function readTracksUnderFolder(db, folderPath, search = '') {
  ...
  addTokenSearchFilter(where, params, ['title', 'artist', 'album', 'normalized_relative_path'], search, 'folderLibrarySearch');
