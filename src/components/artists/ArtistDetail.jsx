...
const artistHeroClassName = [
  'artist-hero detail-hero-flat tw-relative tw-grid tw-grid-cols-[220px_minmax(0,1fr)] tw-items-center tw-gap-7',
...
const artistAlbumGridClassName = 'library-album-grid tw-grid tw-grid-cols-[repeat(auto-fill,minmax(0,min(var(--album-card-size),100%)))] tw-gap-3.5';
